...
set "FX_VERSION=v0.3.1"
set "TETRIS_JAR_DOWNLOAD_URL=https://github.com/takayamaekawa/fx/releases/download/%FX_VERSION%/fx-takayamaekawa-%FX_VERSION%-SNAPSHOT.jar"
set "APP_JAR_NAME=fx-takayamaekawa-%FX_VERSION%-SNAPSHOT.jar"

REM set "WORK_DIR_BASE=%USERPROFILE%\Desktop"
set "WORK_DIR_BASE=%~dp0"
set "WORK_DIR_NAME=takayamaekawa_tetris_game_env_%FX_VERSION%"
